...
public class GigaChatService {
    ...
    {
        "situation": "1-3 предложения текущей ситуации",
        "options": ["вариант1 (до 10 слов)", "вариант2", "вариант3"],
        "reduced_situation": "Текущая ситуация вместе включающая выбранное действие пользователя, в сокращенной форме, 
                    сократи до короткого предложенияя."
        "is_ended": false/true
    }
    ...
    4. situation - НИ В КОЕМ СЛУЧАЕ НЕ ДОЛЖНО СОДЕРЖАТЬ ВАРИНАНТЫ ДЕЙСТВИЙ
    5. reduced_situation -  НИ В КОЕМ СЛУЧАЕ не содержит варианты действия. 
    6. reduced_situation - Максимум 10 слов.
    7. reduced_situation - НЕ СОДЕРЖИТ ВОПРОС
    """;
    ...
    ОТВЕТ СТРОГО В ФОРМАТЕ:
    {
        ...
        "options": ["вариант1 (до 10 слов)", "вариант2", "вариант3"],
        "reduced_situation": "Текущая ситуация включающая выбранное действие пользователя, в сокращенной форме, 
                    сократи до короткого предложенияя."
        "is_ended": false/true
    }
    Жёсткие требования:
